<?php
	...
	interface PowerHour_Wikitude_IPOI 
	{
		...
		/**
		 * @return PowerHour_Wikitude_Attachment Can be a link to a resource (image, PDF file, ...). You could use this to issue coupons or vouchers for potential clients that found you via Wikitude.
		 */
